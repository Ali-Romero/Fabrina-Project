  ...
  <ui-form class="feedback-modal-call" @submit="submit">
    <div class="feedback-modal-call__wrapper">
      <div class="feedback-modal-call__image">
        <img
          src="@/assets/images/feedback-leave-img.png?webp"
          alt="image"
          width="328"
          height="587"
          loading="lazy"
      ...
      <div class="feedback-modal-call__top">
        <div class="feedback-modal-call__title">
          Уже уходите?
          <span
            >Не забудьте заполнить форму, чтобы получить консультацию по
            пошиву</span
          >
        </div>
  ...
  data() {
    return {
      ...
      fields: {
        ...
        phone: '',
        'section-name-text':
          'Уже уходите? Не забудьте заполнить форму, чтобы получить консультацию по пошиву',
...
.feedback-modal-call
  ...
  &__top
    ...
    @media (min-width: map-get($breakpoints, 'lg'))
      max-width: 392px
      padding: 30px 21px 35px 9px
    @media (min-width: map-get($breakpoints, 'xxxl'))
      max-width: 435px
      padding: 40px 21px 35px 53px
  &__title
    font-size: 17px
    line-height: 21px
    margin-bottom: 20px
