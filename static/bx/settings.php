<?php
define('C_REST_CLIENT_ID', 'local.63a180cfedaf08.11755519');//Application ID
define('C_REST_CLIENT_SECRET', '7oecYnGVJQlLTsZj9RQLBLGJU3Pd6SPfaxBIlUWqVl8dPuGwpb');//Application key
// or
