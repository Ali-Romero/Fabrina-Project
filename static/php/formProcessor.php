...
// Pre settings
define('SND_FROM', 'info@fabrina.shop');
define(
    'SND_TO',
    'franch5.leads@gmail.com, leads@conversionpro.agency, Man741@inbox.ru, index@fabrina.shop'
...
$groups = [
    '1) Информация, указанная посетителем сайта:' => [
        'fields' => ['name', 'phone', 'email', 'city', 'question'],
        'html' => '',
    ],
    ...
    if (SND_TO_BITRIX) {
        ...
        $leadRsp = CRest::call('crm.lead.add', [
            'fields' => [
                ...
                'UF_CRM_1650794493' => 'https://fabrina.shop/',
                'SOURCE_ID' => 'CALL',
...
if (mailer(SND_TO, $subject, $htmlBody, $_FILES, $headers)) {
    if (
